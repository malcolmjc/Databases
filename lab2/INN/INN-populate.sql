...
VALUES
   ...
   ('AOB','Abscondorbolster',2,'Queen',4,175,'traditional'),
   ('MWC','Mendicantwithcryptic',2,'Double',4,125,'modern'),
   ('HBB','Harbingerbutbequest',1,'Queen',2,100,'modern'),
   ('IBD','Immutablebeforedecorum',2,'Queen',4,150,'rustic'),
   ('TAA','Thriftandaccolade',1,'Double',2,75,'modern'),
   ('CAS','Convokeandsanguine',2,'King',4,175,'traditional'),
   ('RTE','Riddletoexculpate',2,'Queen',4,175,'rustic'),
   ('FNA','Frugalnotapropos',2,'King',4,250,'traditional');
